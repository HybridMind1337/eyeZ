...
if ($checkServers->num_rows > 0) {
    ...
    while ($row = mysqli_fetch_assoc($checkServers)) {
        ...
        if (file_exists($_SERVER['DOCUMENT_ROOT'] . '/eyez/assets/maps/' . $getType . '/' . $getMap . '.jpg')) {
            $getImage = "<img src='//$getHTTP/eyez/assets/maps/$getType/$getMap.jpg' width='25' height='18' alt='$getMap' /> ";
        ...
        <tr>
            ...
            <td><span class='badge badge-pill badge-dark' onclick='prompt("<?php echo $getName; ?>:","<?php echo $getIP; ?>"); return false;'><?php echo $getIP; ?></span>
            </td>
            <td>
                <div class="progress" style="height: 20px;">
                    ...
                    <div class="progress-bar progress-bar-striped progress-bar-animated <?php echo $bg; ?>" role="progressbar" style="width: <?php echo $per_cent; ?>%;" aria-valuenow="<?php echo $per_cent; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </td>
            <td><?php echo $getImage; ?><?php echo $getMap; ?></td>
            <td>
                <a href="https://www.gametracker.com/server_info/<?php echo $getIP; ?>/"><img src="//<?php echo $getHTTP; ?>/eyez/assets/img/gt.png" alt="Сървъра в GameTracker.COM"/></a>
                <a href="steam://connect/<?php echo $getIP; ?>"><img src="//<?php echo $getHTTP; ?>/eyez/assets/img/steam.png" alt="Влез чрез Steam "/></a>
            </td>
        </tr>
        <?php
    }
